...
class ModelPresetRunner:
    def __init__(
        ...
        for model_name in config.MODEL_PRESETS[model_preset]:
            try:
        ...
        logger.info(f'{len(self.avail_model_names)} models are available')
        logger.info(f'Build RunModel {first_model_name}')
